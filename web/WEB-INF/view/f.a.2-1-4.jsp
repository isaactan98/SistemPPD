            ...
            if (rs.next()) {
                ...
                if (rs.getInt("Qid") == 4) {
                        ...
                        if (s_score == 5 && attempt < 3) {
                            show = "none";
                            reattempt = "";
                            msg1 = "<p style = 'color:green'>D. Pigpen Cipher</p>";
                            msg2 = "<p style = 'color:green'>A. Reverse Cipher</p>";
                            msg3 = "<p style = 'color:green'>B. Caesar Cipher</p>";
                            msg4 = "<p style = 'color:green'>A. Columnar Transposition</p>";
                            msg5 = "<p style = 'color:green'>D. Rail Fence Cipher</p>";
                            ...
                            msg1 = "D. Pigpen Cipher";
                            msg2 = "A. Reverse Cipher";
                            msg3 = "B. Caesar Cipher";
                            msg4 = "A. Columnar Transposition";
                            msg5 = "D. Rail Fence Cipher ";
                            show = "none";
                            reattempt = "";
                            request.setAttribute("msg1", msg1);
                            request.setAttribute("msg2", msg2);
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="chart-area" style="height: auto">
                                            <!-- Start Form -->
                                            <form action="FormativeServ4" method="post">
                                                ...
                                                <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <div
                                                        ...
                                                        <p>Soalan 2</p>
                                                        <h5>
                                                            2. Kaedah sifer yang manakah berkaitan dengan kelemahan yang berikut? <br>
                                                            -	Tidak menggunakan kunci <br>
                                                            -	Mesej mudah dinyahsulit dengan hanya menyongsangkannya <br>
                                                        </h5>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question2" value="a" id="question2a"/><label for="question2a">
                                                                A. Reverse Cipher</label>
                                                        </div>
                                                        <div class="wrapper">
                                                    ...
                                                    <div
                                                        ...
                                                        <p>Soalan 3</p>
                                                        <h5>
                                                            3. Kaedah sifer yang manakah berkaitan dengan kelemahan yang berikut? <br>
                                                            -	Kaedah cuba-jaya boleh digunakan untuk meramal nilai kunci <br>
                                                        ...
                                                        <div class="wrapper">
                                                            <input type="radio" name="question3" value="c" id="question3c"/> <label for="question3c">
                                                                C. Columnar Transposition </label>
                                                        </div>
                                                        <div class="wrapper">
                                                    ...
                                                    <div
                                                        ...
                                                        <p>Soalan 4</p>
                                                        <h5>
                                                            4. Kaedah sifer yang manakah berkaitan dengan kekuatan yang berikut? <br>
                                                            -	Menggunakan kunci <br>
                                                            -	Nombor pada lajur yang berdasarkan kunci sukar diramal <br>
                                                        </h5>
                                                        <div class="wrapper">
                                                    ...
                                                    <div
                                                        ...
                                                        <p>Soalan 5</p>
                                                        <h5>
                                                            5. Kaedah sifer yang manakah berkaitan dengan kekuatan yang berikut? <br>
                                                            -	Menggunakan kunci, iaitu baris <br>
                                                            -	Bilangan baris sukar diramal <br>
                                                        </h5>
                                                        <div class="wrapper">
