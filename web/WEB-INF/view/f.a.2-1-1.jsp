            ...
            if (rs.next()) {
                ...
                if (rs.getInt("Qid") == 1) {
                    ...
                    if (s_score == 5 && attempt < 3) {
                        show = "none";
                        reattempt = "";
                        msg1 = "<p style = 'color:green'>D. Kajian tentang teknik kerahsiaan atau dikenali sebagai keselamatan komunikasi data</p>";
                        msg2 = "<p style = 'color:green'>B. WhatsApp</p>";
                        msg3 = "<p style = 'color:green'>C. II dan IV</p>";
                        msg4 = "<p style = 'color:green'>A.  Ketekalan (Consistency)</p>";
                        msg5 = "<p style = 'color:green'>C. Perkhidmatan keselamatan yang mengenal pasti sebarang perubahan terhadap maklumat atau data oleh pihak lain. <p style = 'color:green'>";
                        ...
                        msg1 = "D. Kajian tentang teknik kerahsiaan atau dikenali sebagai keselamatan komunikasi data";
                        msg2 = "B. WhatsApp";
                        msg3 = "C. II dan IV";
                        msg4 = "A. Ketekalan (Consistency)";
                        msg5 = "C. Perkhidmatan keselamatan yang mengenal pasti sebarang perubahan terhadap maklumat atau data oleh pihak lain. ";
                        show = "none";
                        reattempt = "";
                        request.setAttribute("msg1", msg1);
                        request.setAttribute("msg2", msg2);
                                ...
                                <div class="col-xl-8 col-lg-12">
                                    ...
                                    <div class="card-body">
                                        <div class="chart-area" style="height: auto">
                                            <!-- Start Form -->
                                            <form action="FormativeServ" method="post">
                                                ...
                                                <div class="tab-content" id="myTabContent">
                                                    <div
                                                        ...
                                                        <p>Soalan 1</p>
                                                        <h5>
                                                            1. Apakah itu kriptografi?
                                                        </h5>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question1" value="a" id="question1a"/><label for="question1a">
                                                                A. Tulisan yang dicipta oleh manusia pada zaman purba</label>
                                                        </div>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question1" value="b" id="question1b"/><label for="question1b">
                                                                B. Bahasa pengaturcaraan yang digunakan untuk menghasilkan perisian</label>
                                                        </div>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question1" value="c" id="question1c"/><label for="question1c">
                                                                C. Bahasa bukan lisan yang digunakan oleh orang kurang upaya</label>
                                                        </div>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question1" value="d" id="question1d"/><label for="question1d">
                                                                D. Kajian tentang teknik kerahsiaan atau dikenali sebagai keselamatan komunikasi data</label>
                                                        </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <p>Soalan 2</p>
                                                        <h5>
                                                            2. Manakah yang berikut ialah contoh aplikasi yang menggunakan kriptografi?
                                                        </h5>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question2" value="a" id="question2a"/><label for="question2a">
                                                                A.  Microsoft Word</label>
                                                        </div>
                                                        <div class="wrapper">
                                                    ...
                                                    <div
                                                        ...
                                                        <p>Soalan 3</p>
                                                        <h5>
                                                            3. Mengapakah kriptografi diwujudkan?<br>
                                                            I. untuk menolong orang kurang upaya untuk menyampaikan mesej<br>
                                                            II. untuk melindungi informasi daripada terdedah dan dipintas oleh pihak lain<br>
                                                            III. untuk mengganti bahasa lazim yang digunakan pada zaman sekarang<br>
                                                            IV. untuk mengatasi masalah pencerobohan maklumat penting atau sulit<br>
                                                    ...
                                                    <div
                                                        ...
                                                        <p>Soalan 5</p>
                                                        <h5>
                                                            5. Apakah itu integrity?
                                                        </h5>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question5" value="a" id="question5a"/> <label for="question5a">
                                                                A. Untuk membuktikan bahawa penghantar dan penerima maklumat tidak menafikan bahawa mereka menghantar dan menerima maklumat tersebut.
                                                            </label>
                                                        </div>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question5" value="b" id="question5b"/> <label for="question5b">
                                                                B. Kesulitan sesuatu maklumat yang dihantar melalui rangkaian komputer yang perlu dilindungi supaya maklumat tersebut tidak diketahui oleh pihak lain selain penerima.
                                                            </label>
                                                        </div>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question5" value="c" id="question5c"/> <label for="question5c">
                                                                C. Perkhidmatan keselamatan yang mengenal pasti sebarang perubahan terhadap maklumat atau data oleh pihak lain. 
                                                            </label>
                                                        </div>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question5" value="d" id="question5d"/> <label for="question5d">
                                                                D. Pengenalpastian pihak-pihak yang terlibat dalam suatu komunikasi agar maklumat dihantar oleh pihak yang disahkan. 
                                                            </label>
                                                        </div>
