 ...
 * @author iztan
 */
public class FormativeServ6 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (q1.equals("a")) {
                msg1 = "<p class='bg-gradient-success'>Your Answer is Correct</p>";
                score++;
            } else {
                msg1 = "<p class='bg-gradient-danger'>Your Answer is Incorrect "+q1+"</p>";
            }

            if (q2.equals("a")) {
                msg2 = "<p class='bg-gradient-success'>Your Answer is Correct</p>";
                score++;
            } else {
                msg2 = "<p class='bg-gradient-danger'>Your Answer is Incorrect "+q2+"</p>";
            }

            if (q3.equals("b")) {
                msg3 = "<p class='bg-gradient-success'>Your Answer is Correct</p>";
                score++;
            } else {
                msg3 = "<p class='bg-gradient-danger'>Your Answer is Incorrect "+q3+"</p>";
            }
                ...
                if (rs1.next()) {
                    ...
                    if (rs.next()) {
                        ...
                        if (s_score == 3 && attempt < 3) {
                            show = "none";
                            reattempt = "none";
                            msg1 = "<p style = 'color:green'>A. Betul </p>";
                            msg2 = "<p style = 'color:green'>A. Betul </p>";
                            msg3 = "<p style = 'color:green'>B. Salah</p>";
                        } else if (attempt >= 3) {
                            msg1 = "A. Betul";
                            msg2 = "A. Betul";
                            msg3 = "B. Salah";
                        ...
                        sql = "INSERT INTO public.formative_q (stud_id, \"Qid\", \"Q_num\", \"Q_ans\", s_attempt, s_score) "
                                + "VALUES ("+user_id+","+6+","+3+",'"+markah+"','1',"+score+")";
                        pst = con.prepareStatement(sql);
                        pst.executeUpdate();
                        con.close();
                    }
            ...
            response.sendRedirect("viewFA?v=6");
