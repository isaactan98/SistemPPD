                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="chart-area" style="height: auto">
                                            <!-- Start Form -->
                                            <form action="FormativeServ2" method="post">
                                                ...
                                                <div class="tab-content" id="myTabContent">
                                                    <div
                                                        ...
                                                        <p>Soalan 1</p>
                                                        <h5>
                                                            1. Antara berikut, manakah yang betul tentang Sifer Kunci Tidak Simetri? <br>
                                                            I menggunakan kunci yang sama untuk melakukan penyulitan dan nyahsulit <br>
                                                            II digunakan dalam sifer moden <br>
                                                            III melibatkan dua kunci iaitu kunci awam dan kunci persendirian <br>
                                                            IV kompleks dan melibatkan pengiraan matematik <br>
                                                    ...
                                                    <div
                                                        ...
                                                        <p>Soalan 2</p>
                                                        <h5>
                                                            2. Antara berikut, manakah yang betul tentang Sifer Kunci Simetri? <br>
                                                            I termasuk semua sifer klasik <br>
                                                            II kunci yang digunakan boleh dalam bentuk nombor, huruf, perkataan atau simbol <br>
                                                            III menggunakan kunci yang sama untuk melakukan penyulitan dan nyahsulit <br>
                                                            IV digunakan dalam sifer moden <br>
                                                    ...
                                                    <div
                                                        ...
                                                        <p>Soalan 3</p>
                                                        <h5>
                                                            3. Apakah itu proses penyulitan? 
                                                        </h5>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question3" value="a" id="question3a"/> <label for="question3a">
                                                                A. Proses penukaran teks biasa kepada teks sifer dengan menggunakan algoritma dan kunci penyulitan</label>
                                                        </div>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question3" value="b" id="question3b"/> <label for="question3b">
                                                                B. Proses penukaran teks biasa kepada teks sifer dengan menggunakan bahasa pengaturcaraan</label>
                                                        </div>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question3" value="c" id="question3c"/> <label for="question3c">
                                                                C. Proses penukaran teks sifer kepada teks biasa dengan menggunakan algoritma dan kunci penyulitan </label>
                                                        </div>
                                                        <div class="wrapper">
                                                            <input type="radio" name="question3" value="d" id="question3d"/> <label for="question3d">
                                                                D. Proses penukaran teks sifer kepada teks biasa dengan menggunakan pangkalan data  </label>
                                                        </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <p>Soalan 5</p>
                                                        <h5>
                                                            5. Sila pilih susunan langkah-langkah penyulitan yang betul. <br>
                                                            I Mesej ini akan disulitkan menggunakan satu kunci dan algoritma penyulitan.  <br>
                                                            II Teks sifer, iaitu teks yang tidak bermakna akan terhasil. <br>
                                                            III Pengirim menghantar mesej (teks biasa) kepada penerima. <br>
