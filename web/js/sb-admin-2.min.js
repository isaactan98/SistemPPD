...
!function(s) {
    ...
    s("#sidebarToggle, #sidebarToggleTop").on("click", function(e) {
        ...
        s(".content-wrapper-pl").toggleClass("toggled"),
        s(".sidebar").hasClass("toggled") && s(".sidebar .collapse").collapse("hide") && s(".content-wrapper-pl").removeClass("open") && s(".sidebar").removeClass("open"),
        !s(".content-wrapper-pl").hasClass("toggled") && s(".content-wrapper-pl").addClass("open") && s(".sidebar").addClass("open")
    }),
    s(window).resize(function() {
        ...
        s(window).width() > 480 && s(".sidebar").removeClass("toggled") && s("body").removeClass("sidebar-toggled") && s(".sidebar").removeClass("open") && s(".content-wrapper-pl").removeClass("open")
    }),
